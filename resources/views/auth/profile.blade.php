          ...
          <div class="d-flex flex-column align-items-center">
            <div class="profile-avatar mb-3">
              <img
                ...
                class="avatar-img shadow border border-3 border-info" alt="Avatar"
              ...
              <tbody>
                @foreach ($user->articles as $article)
                  <tr>
                    ...
                    <td>
                      <a href="{{route('articles.edit', $article->id)}}" class="btn btn-sm btn-outline-warning me-2"
                        title="Edit"><i class="bi bi-pencil"></i></a>
                      <a href="{{route('articles.destroy', $article->id)}}" class="btn btn-sm btn-outline-danger"
        ...
        <div class="card shadow-sm mb-5 border-0 p-4">
          ...
          <form method="POST" action="{{route('users.update', $user->id)}}">
            ...
            <div class="mb-4">
              ...
              <input class="form-control rounded-pill" type="text" name="name" value="{{old('name') ?? $user->name}}"
                placeholder="You really change your name?!">
            </div>
            <div class="mb-4">
              <label class="form-label fw-semibold">Email</label>
              <input class="form-control rounded-pill" type="email" name="email" placeholder="Your brand new email"
          ...
          <ul>
            ...
            <li>
              <a href="{{route('download', 'filename=cookie-policy.pdf')}}"
                class="d-block text-decoration-none text-info fw-semibold"><i class="bi bi-file-earmark-pdf me-2"></i>Cookie
                policy</a>
            </li>
          </ul>
